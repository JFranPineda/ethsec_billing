...
import { changeCount, changeLocation } from "../../actions/location.js";
...
const HomePage = ({ count, location, changeLocation, changeCount }) => {
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    changeCount: (amount) => dispatch(changeCount(amount)),
  };
};
